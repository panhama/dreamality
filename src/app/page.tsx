        ...
        <div className="max-w-2xl mx-4 p-4 bg-white/60 backdrop-blur-sm rounded-lg border border-gray-200 shadow-sm">
          <div className="flex items-start gap-3">
            ...
            <div className="text-xs text-gray-600 leading-relaxed">
              <p className="font-semibold text-gray-700 mb-1">🔒 Privacy & Security</p>
              <p>Your uploaded images and personal information are <strong>never stored on our servers</strong>. All files are processed securely and temporarily, then immediately deleted. Generated images are stored in a <strong>private, encrypted S3 bucket</strong> with strict access controls. We prioritize your privacy and data security.</p>
            </div>
          </div>
        </div>
      </div>
